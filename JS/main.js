const controle =
  document.querySelectorAll(
    "[data-controle]"
  ); /*o data é como um pseudo-atribute, classe que pode ser chamada pelo JS, não necessitando usar as classes do CSS.*/

const estatisticas = document.querySelectorAll("[data-estatistica]");
const pecas = {
  bracos: { forca: 29, poder: 35, energia: -21, velocidade: -5 },
  blindagem: { forca: 41, poder: 20, energia: 0, velocidade: -20 },
  nlucleos: { forca: 0, poder: 7, energia: 48, velocidade: -4 },
  pernas: { forca: 27, poder: 21, energia: -32, velocidade: 43 },
